...
[![Packagist Downloads](https://img.shields.io/packagist/dt/iamirnet/xt.com.svg?style=flat-square)](https://packagist.org/packages/iamirnet/xt.com)
...
#### Windows:
[Download installer for Windows](https://github.com/iamirnet/xt.com/#installing-on-windows)
...
```
See [additional options](https://github.com/iamirnet/xt.com/#config-file-in-home-directory) for more options and help installing on Windows
...
cat >  ~/.config/iamirnet/xt.com.json << EOF
{
    "api-key": "<api key>",
    "api-secret": "<secret>"
}
...
custom location
```php
$api = new iAmirNet\XT\Client( "myfile.json" );
```
...
https://github.com/iamirnet/xt.com/tree/gh-pages
